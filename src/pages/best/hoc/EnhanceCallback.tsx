...
import {
  ...
  SuperButton,
} from "@/components/demo/hocs/buttons"
...
export const Page = () => {
  ...
  return (
    <div css={pageCss}>
      ...
      <ButtonWithLoggingOnClickWithParams onClick={() => setCounter(counter + 1)}>
      ...
      <ButtonWithLoggingOnMountWithParams onClick={() => setCounter(counter + 1)}>
      ...
      <SuperButton logText="everything button" onClick={() => setCounter(counter + 1)}>
        With EVERYTHING
      </SuperButton>
    </div>
  )
